...
public class ElectricSpawners extends JavaPlugin implements Listener, SlimefunAddon {
    ...
    public void onEnable() {
        ...
        ItemGroup itemGroup = new ItemGroup(new NamespacedKey(this, "electric_spawners"), new CustomItemStack(PlayerHead.getItemStack(PlayerSkin.fromHashCode("db6bd9727abb55d5415265789d4f2984781a343c68dcaf57f554a5e9aa1cd")), "&9電力生怪磚"));
    ...
    public String getBugTrackerURL() {
        return "https://github.com/SlimeTraditionalTranslation/ElectricSpawners/issues";
    }
}